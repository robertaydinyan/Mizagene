                            ...
                            <tr style="<?= isset($subject->deleted_at) ? 'pointer-events: none; background: #ff000052' : '' ?>" class="text-center">
                                ...
                                <td class="">
                                    <div class="<?= isset($subject->deleted_at) ? 'd-none' : '' ?>">
                                        <img title="Click to copy" src="/images/truefalse.png" alt="" width="20px" class="mx-sm-0 ms-3 shareLink <?= isset($_GET['type']) && $_GET['type'] == 'cloned' ? 'd-none' : '' ?>" style="cursor:pointer;" data-link="https://youmee.tech/subject?id=<?= $subject->public_id ?>&rep=3&quiz=1">
