...
<div class="modal fade" id="signModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0 px-md-5 mx-md-5 px-2 mx-2">
                <div class="row d-flex align-items-center justify-content-between mb-4 text-center">
                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12 px-0">
                        <img class="navbar-brand mx-0" src="/images/logo.png" alt="Logo" width="240" height="55">
                    </div>
                    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12 mt-md-0 mt-3 px-0">
                        <span style="color: #003C46; font-size: 18px">the World's first <span style="color: rgb(210, 58, 225)">innate character scanner</span></span>
                    </div>
                </div>
                <div style="border: 1px dashed#003C46; border-radius: 7px; padding: 20px; display: flex;" class="mb-4 mx-md-0 mx-1 row">
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 justify-content-md-start text-center d-md-block d-none">
                        <img src="<?= str_replace("/var/www/youmee/web/", "", $subject->image) ?>" style="border-radius: 5px;  object-fit: cover; width: 170px; height: 170px" alt="">
                    </div>
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 mt-md-0 mt-3 d-md-block d-none">
                        <div class="d-flex align-items-center justify-content-md-end justify-content-center">
                            <span style="color: #003C46">generated by</span>
                            <?php if ($subject->user->me) { ?><img class="mx-2" src="<?= str_replace("/var/www/youmee/web/", "", $subject->user->me->image) ?>" style="border-radius: 100%;  object-fit: cover; width: 30px; height: 30px" alt=""><?php } else { ?><i class="fa-solid fa-circle-user fa-xl me-2" style="color: #003C46;"></i><?php } ?>
                            <span><?= $subject->user->username ?></span>
                        </div>
                        <div class="my-2" style="font-size: 20px;color: #003C46"><b><?= $subject->name ?></b></div>
                        <div style="color: #003C46">character traits, behavior, predispositions, communication patterns, willpower and more <br> based only on a <span style="color: rgb(210, 58, 225)">portrait photo</span>, <span style="color: rgb(210, 58, 225)">height</span> and <span style="color: rgb(210, 58, 225)">wrist size</span></span></div>
                    </div>
                    <div class="d-flex col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 justify-content-center px-0 d-md-none">
                        <div class="my-2" style="font-size: 20px;color: #003C46"><b><?= $subject->name ?></b></div>
                    </div>
                    <div class="d-flex col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 justify-content-center px-0 d-md-none">
                        <img src="<?= str_replace("/var/www/youmee/web/", "", $subject->image) ?>" style="border-radius: 5px;  object-fit: cover; width: 170px; height: 170px" alt="">
                    </div>
                    <div class="d-flex col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 justify-content-center mt-3 px-0 d-md-none">
                        <div class="d-flex align-items-center justify-content-md-end justify-content-center">
                            <span style="color: #003C46">generated by</span>
                            <?php if ($subject->user->me) { ?><img class="mx-2" src="<?= str_replace("/var/www/youmee/web/", "", $subject->user->me->image) ?>" style="border-radius: 100%;  object-fit: cover; width: 30px; height: 30px" alt=""><?php } else { ?><i class="fa-solid fa-circle-user fa-xl me-2" style="color: #003C46;"></i><?php } ?>
                            <span><?= $subject->user->username ?></span>
                ...
                <div class="d-flex align-items-center justify-content-between mb-4 row px-3">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 px-0 text-md-start text-center">
...
<button type="button" class="btn btn-primary d-none" data-bs-toggle="modal" id="signModalButton" data-bs-target="#signModal">
</button>
                    ...
                    <div class="card-body pt-3 bigHeight" style="height: 428px;">
                        <div class="d-flex justify-content-between profilePictureContainer">
                            ...
                            <div class="d-flex flex-column px-2 text-center">
                                ...
                                <i class="fa-solid fa-check fa-xl mt-3 pb-3 saveInfo" style="cursor: pointer; display: none; color: #97df2a;" data-subject="<?= $subject->id ?>"></i>
                                <?php endif; ?>
                            </div>
                        </div>
                                                            ...
                                                            <div class="carousel-item parameterItem opinionContainer <?= $check == 0 ? 'active' : '' ?>" data-res="<?= floor($youmeeResult == 0 ? $subject_item_result : $youmeeResult) ?>" data-item="<?= $item->id ?>" data-color="<?= $color ? $reverse[$color] : 4 ?>">
                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                    ...
                                                                    <?php $opinion = ItemReview::find()->where(['item_id' => $item->id])->andWhere(['subject_id' => $subject->id])->one(); if (!$opinion) { ?>
                                                                        <div class="d-flex justify-content-between px-0 align-items-center my-2" style="cursor:pointer;">
                                                                        <?php if (!Yii::$app->user->isGuest): ?>
                                                                            ...
                                                                            <span class="d-flex numdisagree align-items-center" style="display: none!important;"><input type="number" class="disnum" style="border-radius: 5px; border: 1px solid #dee2e6" placeholder="0 - 100"><i class="ms-2 fa-solid fa-check finalsubmit" style="color: #97df2a;" data-item="<?= $item->id ?>" data-subject="<?= $subject->id ?>"></i><i class="fa-solid fa-xmark ms-2 retrieveAgree" style="color: red;"></i></span>
                                                                        <?php endif; ?>
                                                                        </div>
                                                                    <?php } ?>
                                                ...
                                                if ($item && $item->mark != 3):
                                                    ...
                                                    <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-12 d-none d-md-block" >
                                                        <div class="parameterItem opinionContainer" data-res="<?= floor($youmeeResult == 0 ? $subject_item_result : $youmeeResult) ?>" data-item="<?= $item->id ?>" data-color="<?= $color ? $reverse[$color] : 1 ?>">
                                                            ...
                                                            <?php $opinion = ItemReview::find()->where(['item_id' => $item->id])->andWhere(['subject_id' => $subject->id])->one(); if (!$opinion) { ?>
                                                            <div class="d-flex justify-content-between px-0 align-items-center mt-2 mb-4" style="cursor:pointer;">
                                                            <?php if (!Yii::$app->user->isGuest): ?>
                                                                <span class="agree" data-item="<?= $item->id ?>" data-subject="<?= $subject->id ?>"><i class="fa-solid fa-check " style="color: #97df2a;"></i> Agree</span>
                                                                <span class="disagree"> <i class="fa-solid fa-xmark " style="color: red;"></i> Disagree</span>
                                                                <span class="d-flex numdisagree align-items-center" style="display: none!important;"><input type="number" class="disnum" style="border-radius: 5px; border: 1px solid #dee2e6" placeholder="0 - 100"><i class="ms-2 fa-solid fa-check finalsubmit" style="color: #97df2a;" data-item="<?= $item->id ?>" data-subject="<?= $subject->id ?>"></i><i class="fa-solid fa-xmark ms-2 retrieveAgree" style="color: red;"></i></span>
    ...
    <script>
        window.addEventListener('load', function () {
            ...
            <?php if (Yii::$app->user->isGuest): ?>
                $(document).find('#signModalButton').click();
            <?php endif; ?>
            ...
            $('.retrieveAgree').click(function () {
                $(this).parent().parent().addClass('d-flex');
                $(this).parent().addClass('d-none');
                $(this).parent().parent().find('.agree').removeClass('d-none');
                $(this).parent().parent().find('.disagree').removeClass('d-none');
            })
