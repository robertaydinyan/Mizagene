            ...
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 px-lg-0">
                ...
                <div class="flex-column d-flex justify-content-between bg-white mx-auto mt-3 mt-lg-0" style="border-radius: 5px;">
                    <div class="row d-flex">
                        ...
                        <div class=" col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 align-items-start pt-3 px-4">
                            <div class="d-flex">
                                ...
                                <div class="dropdown-menu mt-3 filterContainer" style="width: 250px; padding: 10px">
                                    ...
                                    <div class="parameterSearch searchFilter" style="display: none;">
                                        <select name="form-select my-2" id="" class="select2" >
                                            <?php $checkItem = []; foreach ($rep->groups as $gr):
...
<!--                                    <img src="/images/view.png" style="width: 25px" alt="" class="me-2">-->
<!--                                    <span>Views: 13</span>-->
<!--                                </div>-->
<!--                                <div class="d-flex me-4">-->
<!--                                    <img src="/images/yes_no.png" style="width: 25px" alt="" class="me-2">-->
<!--                                    <span>Checks: 7</span>-->
<!--                                </div>-->
<!--                                <div class="d-flex me-4">-->
<!--                                    <img src="/images/test.png" style="width: 25px" alt="" class="me-2">-->
<!--                                    <span>Results: 7</span>-->
<!--                                </div>-->
<!---->
<!--                            </div>-->
                                                    ...
                                                    <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-12 d-none d-md-block" >
                                                        <div class="parameterItem opinionContainer" data-res="<?= floor($youmeeResult == 0 ? $subject_item_result : $youmeeResult) ?>" data-item="<?= $item->id ?>" data-color="<?= $color ? $reverse[$color] : 1 ?>">
                                                            <div class="" style="border: 1px solid #d2d2d2; border-radius: 5px; height: 330px">
                                                                ...
                                                                <p class="dotsP" style="padding-left: 10px; padding-right: 10px; overflow-y: scroll; z-index: 8; position: relative" >
                                                                    <i><?= $item->getTitle($subjectLang)->description ?></i>
                                                                </p>
                                                            </div>
