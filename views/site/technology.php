<?php include('header.php')?>
    ...
    <div class="container-fluid firstContainer" style="min-height: 450px">
        ...
        <div class="container row d-flex mx-auto px-0" style="padding-top: 155px">
            <h1 class="title" style="font-family: 'Nunito Sans', sans-serif;"><span style="color: #003C46"><?= $data['t_tile'][$lang] ?></span></h1>
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-5" style="text-align: start">
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="font-weight: 400; color: #003C46"><?= $data['t_tile1'][$lang] ?></span></p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['t_tile2'][$lang] ?> <span style="font-weight: 400; color: #003C46"><?= $data['t_tile3'][$lang] ?></span>, <span style="font-weight: 400; color: #003C46"><?= $data['t_tile4'][$lang] ?> </span>, <span style="font-weight: 400; color: #003C46"><?= $data['t_tile5'][$lang] ?> </span> и <span style="font-weight: 400; color: #003C46"><?= $data['t_tile6'][$lang] ?></span>.<?= $data['t_tile7'][$lang] ?></p>
                </div>
    ...
    <div class="container mt-3">
        <div class="container row d-flex mx-auto px-0" style="margin: 0 auto!important; padding: 0!important; position: absolute; top: 0;">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center mb-5">
                <h1 style="color: #003C46"><?= $data['command_m'][$lang] ?></h1>
            </div>
...
<div class="container mt-5 mb-5">
    <div class="container row mx-auto px-0">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center mb-5">
            <h1 style="color: #003C46"><?= $data['Наука «Mizagene»'][$lang] ?></h1>
        </div>
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5" style="text-align: start">
            <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['В основе запатентованной технологии лежит одноименное ближневосточное научное учение Mizagene.'][$lang] ?></p>
            <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Один из принципов этого учения в переносе на современный язык гласит следующее: «Человек рождается , таким какой он есть, а лицо человека, как открытая книга, отражает его суть».'][$lang] ?></p>
            <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Учение Mizagene утверждает, что человек в течение жизни не меняется, а любые изменения в его поведении объясняются сознательным выбором, то есть адаптацией личности к социальной среде под влиянием приобретенного опыта. При этом подсознание, отвечающее за неконтролируемые сознанием процессы сильных изменений не претерпевает.'][$lang] ?></p>
            <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Учение на протяжение веков  сильно эволюционировало, и эпоха за эпохой вбирало знания лучших умов, которые искали закономерности во внешности людей и ее взаимосвязи с их врожденным здоровьем и характером.'][$lang] ?></p>
        </div>
    </div>
</div>
    ...
    <div class="container mt-5 mb-5">
        <div class="container row mx-auto px-0">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center mb-5">
                <h1 style="color: #003C46"><?= $data['Технология: 3 фазы развития'][$lang] ?></h1>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-3" style="padding-right: 30px!important; text-align: start; background-color: rgba(0, 60, 70, 0.1); border-radius: 10px; padding: 15px;">
                <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span>v<?= $data['Драгоценный опыт предков в условиях современного мироустройства оказался несколько примитивен и не смог в полной мере отразить природу современного человека.'][$lang] ?></span><span style="display: block; margin-top: 1rem;"><?= $data['Когда это стало очевидным, и родилась идея создания уникальной технологии, которая бы унаследовала название и суть учения, и вместе с тем вобрала бы в себя знания из сотен исторических и научных трудов и современной научной литературы в области психологии и медицины. Так'][$lang] ?> <span style="font-weight: 400; color: #003C46"><?= $data['в 2006 году'][$lang] ?></span> <?= $data['сформировалась база, которая и'][$lang] ?><span style="font-weight: 400; color: #003C46"><?= $data['легла в основу ядра Технологи.'][$lang] ?> </span></span></p>
                <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="font-weight: 400; color: #003C46"><?= $data['Вторая фаза'][$lang] ?></span> <?= $data['создания Технологии заключалась в математическом обосновании и тестировании выявленных закономерностей'][$lang] ?><span style="font-weight: 400; color: #003C46"><?= $data['на фокус-группе, составившей 200,000 человек.'][$lang] ?></span></p>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-3" style="padding-left: 30px!important; text-align: start; background-color: white; border-radius: 10px; padding: 15px;">
                <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Так появились первые, или'][$lang] ?> <span style="font-weight: 400; color: #003C46"><?= $data['«первичные» параметры'][$lang] ?></span>,<?= $data['выдававшие результат с ошеломительной точностью:'][$lang] ?>  <span style="font-weight: 400; color: #003C46">97%</span>.<?= $data['Эти же параметры и легли в основу третьей фазы создания Технологии – выявления и математического обоснования «новых» параметров, отражающих современный уклад жизни человека и его взаимоотношений с другими.'][$lang] ?> </p>
                <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span><span style="font-weight: 400; color: #003C46"><?= $data['«Новые» параметры'][$lang] ?></span>,<?= $data['как и «первичные» проходят тщательную проверку и рассчитываются исходным кодом программного ядра технологии под контролем психологов и психиатров. Это постоянный процесс, не имеющий конца, так как количество параметров со временем будет только расти.'][$lang] ?> </span> <span style="display: block; margin-top: 1rem;"><span style="font-weight: 400; color: #003C46"><?= $data['На сегодня разработано более 1500 параметров. При этом активно используются только 500 из них.'][$lang] ?></span></span></p>
            </div>
        </div>
    </div>
...
<div class="container mt-5 mb-5">
    <div class="container row mx-auto px-0">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
            ...
            <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Технология получает обезличенную информацию о субъекте и выдает результат на основании алгоритмов программного ядра. Точность результата прошедших тестирование параметров составляет от 80 до 92%, а в некоторых случаях достигает 97%.'][$lang]?>
            </p>
            ...
            <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Также Mizagene можно адаптировать под любую конкретную потребность всего за несколько дней и интегрировать с другими программными продуктами, что делает наше решение очень востребованным и масштабируемым.'][$lang]?>
            </p>
...
<div class="container mt-5 mb-5">
    <div class="container row mx-auto px-0">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5 " style="font-size: 19px;">
            <p class="m-0" style="font-size: 19px;color: rgb(114, 114, 114);"><a href="/service" style="color: #003C46; font-weight: 400"><?= $data['Youmee Technologies'][$lang] ?></a><?= $data[' –  эксклюзивный партнер Mizagene'][$lang] ?><?= $data['Technologies и вендор программного обеспечения типов SAAS и'][$lang] ?> <?= $data['PAAS в  области разработки наукоемких IT решений на базе'][$lang] ?> <?= $data['запатентованной технологии Mizagene.'][$lang] ?></p>
            ...
            <div class="flip-card">
                <div class="flip-card-inner" style="border-radius: 5px;">
                    ...
                    <div class="flip-card-back text-center" style="border-radius: 5px; background: rgb(234, 51, 61)">
                        ...
                        <a href="#" class="learnMore PButton" style="position: absolute; bottom: 10px;"><?= $data['learnMore'][$lang] ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid firstContainer mb-sm-3" style="min-height: 150px">
    ...
    <div class="container mx-auto px-0">
        <div class="container d-grid gap-2 d-md-block col-12 mx-auto text-center" style="margin: 0!important; margin-top: 2rem!important; padding: 0!important; z-index: 10; position: absolute; top: 20px">
            ...
            <button class="btn outlineButton" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSignUp" aria-controls="offcanvasWithBothOptions"><?= $data['button2'][$lang] ?></button>
        </div>
    </div>
</div>
