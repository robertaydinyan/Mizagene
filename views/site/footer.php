                ...
                <div class="row d-flex mx-between px-0" style="margin-top: 22px">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 pe-5">
                        <div class="p-2 text-start" style="color: rgb(114, 114, 114); border-bottom: 1px dotted  rgb(114, 114, 114);">
                            <a href="/service"><?= $data['О компании'][$lang] ?></a></div>
                        <div class="p-2 text-start" style="color: rgb(114, 114, 114); border-bottom: 1px dotted  rgb(114, 114, 114);"><a href="#"><?= $data['Цели и принципы работы'][$lang] ?></a></div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ps-5">
                        <div class="p-2 text-start" style="color: rgb(114, 114, 114); border-bottom: 1px dotted  rgb(114, 114, 114);"><a href="/about-technology"><?= $data['О Технологии'][$lang] ?></a></div>
                        <div class="p-2 text-start" style="color: rgb(114, 114, 114); border-bottom: 1px dotted  rgb(114, 114, 114);"><a href="/faq"><?= $data['FAQ'][$lang] ?></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-5 col-lg-5 col-md-11 col-sm-11 col-11 d-flex justify-content-center pt-1 px-0">
            <div class="row d-flex mt-5">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 pe-0" style="height: min-content">
                    <a href="/individual-solutions">
                    <div class="d-flex">
                        <img src="/images/individual_white.png" alt="" width="40px" height="40px" style="align-self: center">
                        <span style="align-self: center; margin: 0 0 0 10px;"><?= $data['solutions1'][$lang];?> </span>
                    </div>
                    </a>

                    <a href="/kyc-solutions">
                    <div class="d-flex mt-2">
                        <img src="/images/kyc_white.png" alt="" width="35px" height="35px" style="align-self: center; margin-left: 3px">
                        <span style="align-self: center; margin: 0 0 0 15px;"><?= $data['solutions3'][$lang];?> </span>
                    </div>
                    </a>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 pe-0"  style="height: min-content">
                    <a href="/personal-solutions">
                    <div class="d-flex ps-3">
                        <img src="/images/talent_white.png" alt="" width="30px" height="30px" style="align-self: center">
                        <span style="align-self: center; margin: 0 0 0 10px;"><?= $data['card2_title'][$lang];?> </span>
                    </div>
                    </a>
                ...
                <div class="row d-flex col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="height: min-content">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 pe-5" style="height: min-content">
                        <div class="p-2 pt-0" style="color: rgb(114, 114, 114); border-bottom: 1px dotted  rgb(114, 114, 114);"><a href="/investors"><?= $data['subtitle3'][$lang] ?></a></div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ps-5" style="height: min-content">
                        <div class="p-2 pt-0" style="color: rgb(114, 114, 114); border-bottom: 1px dotted  rgb(114, 114, 114);"><a href="/partners"><?= $data['subtitle6'][$lang] ?></a></div>
                    </div>
                </div>
