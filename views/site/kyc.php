<?php include('header.php')?>
    ...
    <div class="container-fluid firstContainer" style="min-height: 450px">
        ...
        <div class="container d-flex" style="padding-top: 155px">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-5 text-center">
                <h1 class="title" style="font-family: 'Nunito Sans', sans-serif;"><span style="color: #003C46">KYC Модули</span></h1>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5" style="text-align: start">
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">Если у вас большая клиентская база, а бизнес-процессы требуют обязательной верификации пользователей, - Вы наверняка уже внедрили или приняли решение по внедрению системы типа KYC (Know Your Customer). Они используются для подтверждения контрагентов перед проведением финансовых операций и широко применимы в следующих индустриях:</p>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-5 text-center">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 mb-5">
                <div class="row d-flex">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5 text-center">
                        <h4 style="color: #003C46; margin-bottom: 0; padding-bottom: 0">FinTech (финансовые организации, банки)</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 mb-5">
                <div class="row d-flex">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5 text-center">
                        <h4 style="color: #003C46; margin-bottom: 0; padding-bottom: 0">Индустрия игр и развлечений</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 mb-5">
                <div class="row d-flex">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5 text-center">
                        <h4 style="color: #003C46; margin-bottom: 0; padding-bottom: 0">Сфера страхования и медицины</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 mb-5">
                <div class="row d-flex">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5 text-center">
                        <h4 style="color: #003C46; margin-bottom: 0; padding-bottom: 0">Электронная коммерция и шеринговые компании</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row d-flex">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="text-align: start; background-color: white; border-radius: 10px; padding: 15px; padding-right: 30px!important">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-start mb-4">
                        <img src="/images/kyc_options.png" alt="" width="70px">
                        <h5 style="margin-left: 20px; color: #003C46; align-self: center; margin-bottom: 0;">Основные этапы <br> процессинга информации в рамках KYC</h5>
                    </div>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="font-weight: 500; color: #003C46">1.</span> Обработка документа</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="font-weight: 500; color: #003C46">2.</span> Сбор биометрической информации в рамках фото и видео съемки</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="font-weight: 500; color: #003C46">3.</span> Сопоставление фото с документом (FaceMatching)</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="font-weight: 500; color: #003C46">4.</span> Проверка по AML (Anti-Money Laundering) и другим базам</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="font-weight: 500; color: #003C46">5.</span> (в некоторых случаях) обеспечение OTP входа в сервис через биометрическую верификацию лица клиента</p>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-start" style="text-align: start; background-color: rgba(75, 173, 233, 0.2);; border-radius: 10px; padding: 15px; padding-left: 30px!important">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-start mb-5">
                        <h5 style="color: #003C46">Какие задачи решает внедренная KYC система</h5>
                    </div>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-plus me-3" style="color: #003C46;"></i>Защита от мошенников<span style="color: red; font-size: 25px">*</span></p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-plus me-3" style="color: #003C46;"></i>Ускорение верификации клиента</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-plus me-3" style="color: #003C46;"></i>Упрощенный вход в сервис</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-plus me-3" style="color: #003C46;"></i>Исключение ошибок и опечаток</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-plus me-3" style="color: #003C46;"></i>Проверка возраста клиента</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-plus me-3" style="color: #003C46;"></i>Защита от попыток взлома</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="color: red; font-size: 25px">*</span>только на основании имеющихся баз данных</p>
                </div>
            </div>
    ...
    <div class="container mt-5">
        <div class="container row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-start mb-5">
                <h1 style="color: #003C46">Чего <span style="color: #ff2600">ни одна KYC система</span> в мире дать вам не сможет:</h1>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5" style="text-align: start">
                <div class="row d-flex">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-start" style="text-align: start;">
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-xmark me-3" style="color: #ff2600;"></i>Определение целевого клиента уже на этапе верификации</p>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-xmark me-3" style="color: #ff2600;"></i>Предиктивный анализ поведения клиента в вашей системе</p>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-xmark me-3" style="color: #ff2600;"></i>Отраслевой скоринг рисков (разработанный под требования Вашей отрасли)</p>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-xmark me-3" style="color: #ff2600;"></i>Сегментация клиентов для повышения эффективности маркетинговой стратегии</p>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-start" style="text-align: start;">
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-xmark me-3" style="color: #ff2600;"></i>Интеллектуальные и психологические особенности клиента</p>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-xmark me-3" style="color: #ff2600;"></i>Предрасположенность к мошенничеству</p>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-xmark me-3" style="color: #ff2600;"></i>Отношение к деньгам и долговым обязательствам</p>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><i class="fa-solid fa-circle-xmark me-3" style="color: #ff2600;"></i>любые другие репорты, получаемые на основании личной информации о характере человека</p>
                    </div>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-start mb-5">
                    <p class="" style="font-size: 19px;color: #003C46;"><b>Но все это может дать интеграция Вашей KYC системы с Youmee KYC</b> – модулем предиктивного анализа контрагента, который работает на базе технологии Mizagene.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mb-5">
        <div class="container row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center mb-5">
                <h1 style="color: #003C46;">Примеры параметров, которые вы получите</h1>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-between mb-5">
                <p class="text-center" style="font-size: 19px;color: rgb(114, 114, 114);">Ниже предлагаем Вашему вниманию часть параметров, используемых для анализа рисков и повышения маркетинговой эффективности в сфере «игр и развлечений»</p>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-between mb-5">
    ...
    <div class="container mt-5 mb-5">
        <div class="container row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center mb-5">
                <h1 style="color: #003C46">Как это работает</h1>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex mb-5" style="text-align: start">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 d-flex">
                    ...
                    <div style="align-self: center; margin-left: 50px;">
                        <h5>Этап первичного анализа</h5>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">Определение характера человека, его талантов, моделей поведения, способностей и предпочтений, а также предрасположенности к психическим заболеваниям и страстям</p>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ps-3 d-flex">
                    ...
                    <div style="align-self: center; margin-left: 50px;">
                        <h5>Итоговая обработка данных</h5>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">Обработка полученных на этапе первичного анализа данных с учетом специфики бизнеса Заказчика, его требований и утвержденных алгоритмов</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5 mb-5">
        <div class="container row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center mb-5">
                <h1 style="color: #003C46"><img src="/images/new_report.png" alt="" width="50px" style="margin-right: 20px">Создание собственных KYC репортов</h1>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="padding-right: 30px!important; background-color: rgba(75, 173, 233, 0.2); border-radius: 10px; padding: 15px;">
                <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">Как и для Youmee HR, в рамках решений Youmee KYC мы предоставляем <span style="color: #003C46;font-weight: 500">возможность создания неограниченного количества собственных репортов</span> с привязкой к конкретным целям анализа.</p>
                <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">При создании Шаблона, Вы можете указать приоритетность параметров анализа, их весовые значения, влияющие на общий скоринг контрагента, а также настроить параметры-«стопперы».</p>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="padding-left: 30px; background-color: white; border-radius: 10px; padding: 15px;">
                <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">Если ядро технологии выдает неудовлетворительный результат параметра, который вы определили как «стоппер», контрагент получит неудовлетворительный результат скоринга в обход общему установленному алгоритму.</p>
                <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">Тот же принцип работает и в отношении параметров-«бустеров»: в случае получения максимального результата по ним контрагент получит положительный результат скоринга в обход общему установленному алгоритму.</p>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center mb-3 mt-3">
                <h3 style="color: #003C46">Как создать собственный репорт</h3>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex" style="text-align: start">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="background-color: white; border-radius: 10px; padding: 15px; padding-left: 30px!important">
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="color: #003C46;font-weight: 500">1.</span> Создайте собственный шаблон репорта для должности: выберите те параметры, которые вы считаете наиболее важными для сегментации.</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="color: #003C46;font-weight: 500">2.</span> Задайте те значения по параметрам, которые для кандидата будут считаться «хорошими» и «проходными». В дальнейшем система будет сопоставлять фактически значения результатов анализа кандидатов с установленными вами.</p>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="background-color: rgba(75, 173, 233, 0.2); border-radius: 10px; padding: 15px; padding-left: 30px!important">
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="color: #003C46;font-weight: 500">3.</span> Запустите анализ контрагентов по созданному вами репорту</p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><span style="color: #003C46;font-weight: 500">4.</span> Фильтруйте по отдельным параметрам, экспортируйте в удобном формате, редактируйте созданный вами шаблон для получения более релевантного результата или запустите передачу полученных данных через API в другие системы Вашей инфраструктуры.</p>
                </div>
                </div>
        </div>
    </div>
    ...
    <div class="container mt-5 mb-5">
        <div class="container row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center mb-5">
                <h1 style="color: #003C46">Безопасность храниния данных</h1>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-4" style="text-align: start; padding-right: 30px">
                        <h3 style="color: #003C46">Только обезличенные данные</h3>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">Для обезличенных данных о лице субъекта (координаты контрольных точек и их расстояние относительно друг друга) используется тот же программный код на базе AI, что и при создании визуальных эффектов наложения. Это решение было продиктовано необходимостью быть максимально «прозрачными» в случае использования нашей Технологии с размещением части программного кода на серверах корпоративных пользователей.</p>

                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-4" style="text-align: start; padding-left: 30px">
                        <h3 style="color: #003C46">Варианты поствки ПО</h3>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">В зависимости от размеров компаний, а также целей, которые они преследуют, для корпоративных решений мы предоставляем 2 варианта поставки технологии:</p>
                        <p class="mb-0" style="font-size: 19px;color: rgb(114, 114, 114);">1.  <span style="font-weight: 400; color: #003C46">API</span>. Клиент или Партнер интегрирует нашу систему со своим программным обеспечением и получает результаты скоринга прямо в нем.</p>
                        <p class="" style="font-size: 19px;color: rgb(114, 114, 114);">2.  <span style="font-weight: 400; color: #003C46">SDK (software development kit)</span>, инсталлируется на сервере Клиента.</p>
                ...
                <p style="font-size: 19px;color: rgb(114, 114, 114);">Фотографии субъектов анализа остаются на этом сервере без передачи нам. SDK от Youmee  передает всю необходимую, но при этом обезличенную информацию о контрагенте в виде JSON файла с координатами контрольных точек на лице. Результаты анализа посредством API передаются в систему Клиента.</p>
            </div>
        </div>
    </div>
        ...
        <div class="container row" style="text-align: start; background-color: rgba(75, 173, 233, 0.2); border-radius: 10px; padding: 15px;">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="text-align: start">
                <div class="mb-3">
                    ...
                    <label for="exampleFormControlInput5" class="form-label">Продукт Youmee*</label>
