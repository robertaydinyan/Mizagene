    ...
    <div class="container-fluid firstContainer" style="min-height: 450px">
        ...
        <div class="container d-flex row mx-auto px-0" style="padding-top: 155px">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-5 mt-3 text-center">
                <h1 class="title" style="font-family: 'Nunito Sans', sans-serif;"><span style="color: #003C46"><?= $data['subtitle6'][isset($_GET['lang']) ? 'en' : 'ru']?></span></h1>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5" style="text-align: start">
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Компания Youmee Technologies открыта для сотрудничества и предлагает 3 возможных варианта:'][isset($_GET['lang']) ? 'en' : 'ru']?></p>
                </div>
            </div>
    ...
    <div class="container row mx-auto px-0">
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-5 pe-sm-5 mx-auto">
            <div class="row d-flex">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5 text-center">
                    <h2 style="color: #003C46; margin-bottom: 0; padding-bottom: 0"><?= $data['Дистрибуция'][isset($_GET['lang']) ? 'en' : 'ru']?></h2>
                    <h5 style="color: #003C46"> <?= $data['услуг и продуктов Youmee Technologies в вашем регионе'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </h5>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="text-align: start">
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Подробную информацию о предлагаемых нами условиях сотрудничества в разрезе продуктов и услуг Вы получите в рамках совместной сессии. Дилерская скидка с продажи API запросов составляет 25%. Дистрибьюторская скидка составляет от 30 до 50%.  Это зависит от продукта, типа сотрудничества и формата поставки. При этом, 100% от стоимости внедрения сложных корпоративных продуктов забирает Дилер.'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-5">
            <div class="row d-flex">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5 text-center">
                    <h2 style="color: #003C46; margin-bottom: 0; padding-bottom: 0"><?= $data['Интеграция'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </h2>
                    <h5 style="color: #003C46"><?= $data['технологии Mizagene c Вашим приложением или корпоративным ПО'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </h5>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5" style="text-align: start">
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Создайте дополнительную ценность вашим клиентам – усильте имеющиеся продукты модульными решениями от Youmee Technologies. Условия сотрудничества зависят от отрасли, популярности Вашего ПО и объема клиентской базы. '][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-5 ps-sm-5 mx-auto">
            <div class="row d-flex">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5 text-center">
                    <h2 style="color: #003C46; margin-bottom: 0; padding-bottom: 0"><?= $data['Создание'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </h2>
                    <h5 style="color: #003C46"><?= $data['новых продуктов с использованием технологии Mizagene'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </h5>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="text-align: start">
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Условия партнерства в рамках разработки нового программного обеспечения обсуждаются индивидуально.'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </p>
                    <p class="" style="font-size: 19px;color: rgb(114, 114, 114);"><?= $data['Все, что для этого нужно, это просто заполнить форму ниже, выбрать формат и в поле «комментарий» написать суть вашего запроса. Мы оперативно свяжемся с Вами.'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </p>
                    <p></p>
                </div>
            </div>
...
<div class="container mb-5">
    <div class="container row mx-auto px-0" style="text-align: start; background-color: rgba(75, 173, 233, 0.2); border-radius: 10px; padding: 15px;">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center mb-3">
            <h1 style="color: #003C46"><?= $data['Партнерский отдел'][isset($_GET['lang']) ? 'en' : 'ru']?>
            </h1>
        </div>
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="text-align: start">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="text-align: start">
            <div class="mb-3">
                ...
                <label for="exampleFormControlInput5" class="form-label"><?= $data['Тип сотрудничества*'][isset($_GET['lang']) ? 'en' : 'ru']?>
                </label>
                <select class="form-select" aria-label="Тип сотрудничества*">
                    <option value="1"><?= $data['Дистрибуция'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </option>
                    <option value="2"><?= $data['Интеграция'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </option>
                    <option value="3"><?= $data['Создание'][isset($_GET['lang']) ? 'en' : 'ru']?>
                    </option>
                </select>
